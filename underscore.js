...
(function() {
  ...
  _.indexOf = function(array, item, isSorted) {
    ...
    for (i = _i = 0, _ref1 = array.length; 0 <= _ref1 ? _i < _ref1 : _i > _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
  ...
  _.lastIndexOf = function(array, item) {
    ...
    for (i = _i = _ref1 = array.length; _ref1 <= 0 ? _i < 0 : _i > 0; i = _ref1 <= 0 ? ++_i : --_i) {
      if (i in array && array[i] === item) {
        return i;
      }
    }
  ...
  _.compose = function() {
    ...
    return function() {
      var args, i, _i, _ref1;
      args = arguments;
      for (i = _i = _ref1 = funcs.length - 1; _ref1 <= -1 ? _i < -1 : _i > -1; i = _ref1 <= -1 ? ++_i : --_i) {
  ...
  eq = function(a, b, stack) {
    var className, funcName, key, length, result, size, _i, _len, _ref1;
    if (a === b) {
      return a !== 0 || 1 / a === 1 / b;
    }
    if ((a == null) || (b == null)) {
    ...
    switch (className) {
      ...
      case 'RegExp':
        result = true;
        _ref1 = ['source', 'global', 'multiline', 'ignoreCase'];
